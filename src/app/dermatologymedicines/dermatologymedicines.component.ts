...
@Component({
  selector: 'app-dermatologymedicines',
  templateUrl: './dermatologymedicines.component.html',
  styleUrl: './dermatologymedicines.component.css'
})
export class DermatologymedicinesComponent {
  medicines: any[] = [];
  cartCount: any;
